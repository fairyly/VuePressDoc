...
- 1 .`'import' and 'export' may appear only with 'sourceType: module'`
  ...
  - 参考：[ssues#10397](https://github.com/eslint/eslint/issues/10397)
...
- 3. `error  Parsing error: Unexpected token ..`
...
```
- 参考： [babel-plugin-proposal-class-properties](https://babeljs.io/docs/en/babel-plugin-proposal-class-properties)
- [babel-plugin-preset-files-are-not-allowed-to-export-objects-only-functions](https://stackoverflow.com/questions/47830273/babel-plugin-preset-files-are-not-allowed-to-export-objects-only-functions)


## 参考
- [configuring#specifying-parser-options](https://eslint.org/docs/user-guide/configuring#specifying-parser-options)
- [eslint-plugin-react](https://github.com/yannickcr/eslint-plugin-react)
- [AlloyTeam/eslint-config-alloy](https://github.com/AlloyTeam/eslint-config-alloy/blob/master/react.js)